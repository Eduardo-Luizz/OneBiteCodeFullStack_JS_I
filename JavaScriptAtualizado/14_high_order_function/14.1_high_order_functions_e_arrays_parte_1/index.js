...
const nomes_map = personagens.map(function (personagem) {
...
const orcs_filter = personagens.filter(function (personagem) {
...
const nivelTotal_reduce = personagens.reduce(function (acumulador, personagem) {
